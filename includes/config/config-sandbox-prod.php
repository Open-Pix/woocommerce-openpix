...
class OpenPixConfig
{
    public static $OPENPIX_ENV = 'sandbox-prod';
    public static $OPENPIX_API_URL = 'https://api.woovi-sandbox.dev';
    public static $OPENPIX_PLUGIN_URL = 'https://plugin.woovi-sandbox.dev/v1/openpix.js';
    ...
    public static $OPENPIX_PLATFORM_URL = 'https://app.woovi-sandbox.dev';
