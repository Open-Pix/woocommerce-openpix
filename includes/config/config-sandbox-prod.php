...
class OpenPixConfig
{
    ...
    public static $OPENPIX_API_URL = 'https://api.woovi-sandbox.com';
    public static $OPENPIX_PLUGIN_URL = 'https://plugin.woovi-sandbox.com/v1/openpix.js';
    ...
    public static $OPENPIX_PLATFORM_URL = 'https://app.woovi-sandbox.com';
