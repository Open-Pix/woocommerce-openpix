...
class OpenPixConfig
{
    ...
    public static $OPENPIX_API_URL = 'https://api.woovi.com';
    public static $OPENPIX_PLUGIN_URL = 'https://plugin.woovi.com/v1/woovi.js';
    ...
    public static $OPENPIX_PLATFORM_URL = 'https://app.woovi.com';
