...
class SandboxProdConfigStrategy implements ConfigStrategyInterface
{
    private const OPENPIX_ENV = 'sandbox-prod';
    private const OPENPIX_API_URL = 'https://api.woovi-sandbox.com';
    private const OPENPIX_PLUGIN_URL = 'https://plugin.woovi-sandbox.com/v1/openpix.js';
    ...
    private const OPENPIX_PLATFORM_URL = 'https://app.woovi-sandbox.com';
