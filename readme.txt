...
- Refatoração do fluxo de sandbox para troca de ambiente
- Adicionando `plugin_dir_path` para importações dos arquivos de configuração

= 2.12.1 - 2025-04-17 =

- Correções na validação de telefones usando `libphonenumber`
...
- Aumentar desempenho.
- Suportar versões mais recentes do Woocommerce e WordPress.

= 2.10.6 - 2023-11-10 =

- Melhor suporte ao HPOS.
